...
<body style="background-color: #ffaf36dc; ">
    <div class="container">
        <div class="regformf" >
    <form action="" method="post">
        <p class="logo">Food <b style="color: #ff9900; ">Donate</b></p>
       ...
       <div class="input">
        ...
        <div class="image-radio-group">
          ...
          <br>
          <label for="expirationTime">Expired date:(in Hour)</label>
         <input type="number" id="expirationTime" required"> 
        </div>
        <div class="input">
...
<select id="district" name="district" style="padding:10px;">
  ...
  <option value="tiruchirappalli" selected>Tiruchirappalli</option>
